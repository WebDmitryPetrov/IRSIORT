...
if (empty($_GET['h_id']))
$_GET['h_id']=HeadCenter::getByActID($Act->id)->id;

$head_center_text=HeadCenterText::getByID($_GET['h_id']);
...
$vuz_name=$head_center_text->short_ip;
//Вывод текущей даты :)
$date_day=date('d');
$date_month=date('m');
...
<p>
<? if ($old_view==0) :?>
<div align="right" style="text-align:right"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt;padding-right: 60px;"><b>УТВЕРЖДАЮ</b></span></div>
<div align="right" style="text-align:right">&nbsp;</div>

<div align="right" style="text-align:right"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;padding-right: 60px;">______________________________________</span></div>
<div align="center" style="text-align:center">&nbsp;</div>
<div align="right" style="text-align:right"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;padding-right: 60px;">&laquo;___&raquo; ________________20__ г.</span></div>

<div align="center" style="text-align:center">&nbsp;</div>
<div align="right" style="text-align:right"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;padding-right: 60px;"><?=$sign->position?> <?=$head_center_text->short_ip?></span></div>
<div align="right" style="text-align:right"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;padding-right: 60px;"><?=$sign->caption?></span></div>
<div align="center" style="text-align:center">&nbsp;</div>
<div align="right" style="text-align:right"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;padding-right: 60px;">М.П.</span></div>
<div align="center" style="text-align:center">&nbsp;</div>
	<? endif; 
	...
	if ($old_view==1) :?>
	<div align="right" style="text-align:right;padding-right: 170px;"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt"><b>УТВЕРЖДАЮ</b></span></div>
<div align="right" style="text-align:right">&nbsp;</div>
<div align="right" style="text-align:right"><span style="font-size:
12.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;padding-right: 60px;"><?=$sign->position?> <?=$head_center_text->short_ip?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?=$sign->caption?></span></div>
<div align="right" style="text-align:right">&nbsp;</div>
...
color:#161616;letter-spacing:0pt;font-weight:normal;">&laquo;___&raquo; ________________20__ г.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;М.П.</span></div>
<div align="center" style="text-align:center">&nbsp;</div>
...
<div align="center" style="text-align:center"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt"><b>Ведомость</b></span></div>
<div align="center" style="text-align:center"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt"><b>выдачи справок&nbsp;прохождения&nbsp;государственного&nbsp;тестирования</b></span></div>
<!--<div>&nbsp;</div>
<div>&nbsp;</div>-->
<div>
...
<td align=right>
<span style="font-size:12.0pt;color:#161616;letter-spacing:
0pt;font-weight:normal;float:right;padding-right:30px">Учреждение: &laquo;<b><?=$vuz_name; ?></b>&raquo;</span>-->
</td></tr></table>
</div>
<!--<div><span style="font-size:12.0pt;color:#161616;letter-spacing:
0pt;font-weight:normal;">Организация:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="font-size:12.0pt;
...
<table width="100%" cellspacing="0" cellpadding="0" border="1" style="border-collapse:collapse;border:none;" id="main_table">
    <tbody>
        <tr style="height:63.45pt">
            ...
            <div align="center" style="text-align:center"><span style="font-size:10.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">п/п</span></div>
            </td>
            <td width="250" style="width:150.0pt;border:solid windowtext 1.0pt;border-left:
            none;
            padding:0cm 5.4pt 0cm 5.4pt;height:63.45pt">
            <div align="center" style="text-align:center"><span style="font-size:10.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">Ф.И.О.</span></div>
            </td>
            <td width="85" style="width:63.75pt;border:solid windowtext 1.0pt;border-left:
            none;
            padding:0cm 5.4pt 0cm 5.4pt;height:63.45pt">
            <div align="center" style="text-align:center"><span style="font-size:10.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">Номер, серия паспорта (документа удостоверяющего личность)</span></div>
            </td>
            ...
            none;
            padding:0cm 5.4pt 0cm 5.4pt;height:63.45pt">
            <div align="center" style="text-align:center"><span style="font-size:10.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">Номер  справки</span></div>
            ...
            none;
            padding:0cm 5.4pt 0cm 5.4pt;height:63.45pt">
            <div align="center" style="text-align:center"><span style="font-size:10.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">Дата тестирования</span></div>
            </td>
			<td width="94" style="width:70.85pt;border:solid windowtext 1.0pt;border-left:
            none;
            padding:0cm 5.4pt 0cm 5.4pt;height:63.45pt">
            <div align="center" style="text-align:center"><span style="font-size:10.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">Уровень тестирования</span></div>
            </td>
            <td width="68" style="width:50.8pt;border:solid windowtext 1.0pt;border-left:
            none;
            padding:0cm 5.4pt 0cm 5.4pt;height:63.45pt">
            <div align="center" style="text-align:center"><span style="font-size:10.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">Общий</span></div>
            <div align="center" style="text-align:center"><span style="font-size:10.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">балл</span></div>
            </td>
            <td width="121" style="width:90.8pt;border:solid windowtext 1.0pt;border-left:
            none;
            padding:0cm 5.4pt 0cm 5.4pt;height:63.45pt">
            <div align="center" style="text-align:center"><span style="font-size:10.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">Подпись лица, прошедшего тестирование</span></div>
            </td>
			<td width="84" style="width:62.75pt;border:solid windowtext 1.0pt;border-left:
            none;
            padding:0cm 5.4pt 0cm 5.4pt;height:63.45pt">
            <div align="center" style="text-align:center"><span style="font-size:10.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">Примечание</span></div>
            <div align="center" style="text-align:center">&nbsp;</div>
            </td>
        </tr>
            ...
            none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;padding:0cm 5.4pt 0cm 5.4pt;height:17.0pt">
            <div align="center" style="text-align:center"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">'.$Man->blank_number.'</span></div>
            </td><!---->
            ...
            <td width="94" valign="top" style="width:70.85pt;border-top:none;border-left:
            none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;padding:0cm 5.4pt 0cm 5.4pt;height:17.0pt">
            <div align="center" style="text-align:center"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">'./*TestLevel::getByID(ActTest::getByID($Man->test_id)->level_id)*/TestLevel::getByID(ActTest::getByID($Man->test_id)->level_id)->getPrintAct().'</span></div>
            </td>
...
<? if ($old_view==0) :?>
<div align="center" style="text-align:left;padding-left:30px;"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">По настоящей ведомости выдано справок_______________________(количество прописью)<!--<u><?php echo num2str($i);?></u> сколько выдано сертификатов - прописью--></span></div>

<br>



<table style="width:55%;" align="left">
<tr>
<td align="right" style="text-align:left; padding-left:30px; width:800px;">
<span style="font-size:12.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;"><?=$rukovod_dolzhn_1?></span></td>
<td style="width:250px;">&nbsp;
</td>
<td align="left" style="text-align:left; "><span style="font-size:
12.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;"><nobr><?=$rukovod_fio?></nobr>
</td>
</tr>
<tr><td colspan=3>&nbsp;</td></tr>
<tr>
<td align="left" style="text-align:left; padding-left:30px;"><span style="font-size:
12.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">Ответственный за проведение тестирования </td>
<td width=550>&nbsp;
</td>
<td align="left" style="text-align:left "><span style="font-size:
12.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;"><nobr><?=$Act->responsible; ?></nobr>
	...
	<div align="center" style="text-align:center"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">По настоящей ведомости выдано справок_______________________(количество прописью)<!--<u><?php echo num2str($i);?></u> сколько выдано сертификатов - прописью--></span></div>

<br>
<table style="width:65%;" align="center">
<tr>
<!--<td align="right" style="text-align:right; width:800px;"><span style="font-size:
12.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">Директор центра тестирования <?=$head_center_text->short_ip?></td>-->

<td align="right" style="text-align:right; width:800px;"><span style="font-size:
12.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;"><?=$rukovod_dolzhn_1?></td>
<td style="width:250px;">&nbsp;
</td>
<!--<td align="left" style="text-align:left; "><span style="font-size:
