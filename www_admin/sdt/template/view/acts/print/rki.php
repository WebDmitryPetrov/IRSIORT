...
$peresdacha = 0;
/*if ($balli1 < $Level->percent_max) {
    $balli1_ocenka = 'неудовлетворительно';
    $razdeli_peresdacha = '&laquo;' . $razd1 . '&raquo;, ';
    $peresdacha++;
} else {
    $balli1_ocenka = 'удовлетворительно';
}
if ($balli2 < $Level->percent_max) {
    $balli2_ocenka = 'неудовлетворительно';
    $razdeli_peresdacha .= '&laquo;' . $razd2 . '&raquo;, ';
    $peresdacha++;
} else {
    $balli2_ocenka = 'удовлетворительно';
}
if ($balli3 < $Level->percent_max) {
    $balli3_ocenka = 'неудовлетворительно';
    $razdeli_peresdacha .= '&laquo;' . $razd3 . '&raquo;, ';
    $peresdacha++;
} else {
    $balli3_ocenka = 'удовлетворительно';
}
if ($balli4 < $Level->percent_max) {
    $balli4_ocenka = 'неудовлетворительно';
    $razdeli_peresdacha .= '&laquo;' . $razd4 . '&raquo;, ';
    $peresdacha++;
} else {
    $balli4_ocenka = 'удовлетворительно';
}
if ($balli5 < $Level->percent_max) {
    $balli5_ocenka = 'неудовлетворительно';
    $razdeli_peresdacha .= '&laquo;' . $razd5 . '&raquo;, ';
    $peresdacha++;
} else {
    $balli5_ocenka = 'удовлетворительно';
}*/
...
<div align="center" style="margin-right:1.0cm;text-align:center"><b><span style="font-size:20.0pt;">Справка</span></b>
</div>
<div align="center" style="margin-right:1.0cm;text-align:center"><b><u><span
                style="font-size:16.0pt;"><?= $sert_num; ?></span></u></b><b><u><span style="font-size:16.0pt;"></span></u></b>
</div>
...
text-indent:0cm;line-height:150%">проходил тестирование по русскому языку в объёме <b><?= $uroven; ?></b> уровня и
    показал следующие результаты по разделам теста:
</div>
