...
//Уровень
$a=$Act->getPeople();
$uroven= $a[0]->getTest()->getLevel()->print; // как в сертификате
//$uroven= $a[0]->getTest()->getLevel()->getPrintAct(); // как в ведомости


//Название организации
//$org_name=$Act->getUniversity()->name; //полное название
//$org_name=$Act->getUniversity()->short_name; //сокращенное


if ($Act->getUniversity()->short_name != '') $org_name=$Act->getUniversity()->short_name;
else $org_name=$Act->getUniversity()->name; 

//Количество сертификатов и справок
$cert_counter=0;
$sprav_counter=0;
...
<p>
<div align="center" style="text-align:center;pad ding-right: 170px;"><span style="font-size:14.0pt;color:#161616;letter-spacing:0pt"><b>Реестр выдачи сертификатов прохождения государственного тестирования <?=$rukovod_center_name?></b></span></div>
...
font-weight:normal;">М.П</span></div>-->
<!--<div><span style="font-size:10.0pt;color:#161616;letter-spacing:
0pt;font-weight:normal;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></div>-->
<div align="left" style="text-align:left"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt"><b>на уровне: </b><i><?=$uroven?></i></span></div>
<div align="left" style="text-align:left"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt"><b>Организация, проводившая тестирование: </b><i><?=$org_name?></i></span></div>
<div align="left" style="text-align:left"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt"><b>Кол-во сертификатов: </b><i><?=$cert_counter?></i></span></div>
<div align="left" style="text-align:left"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt"><b>Кол-во справок: </b><i><?=$sprav_counter?></i></span></div>
...
<div>&nbsp;</div>-->
<div>&nbsp;</div>
<div align="left" style="text-align:left"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt"><b>Дата составления: <?=$date; ?> г.</b></span></div>
<!--<div>
...
0pt;font-weight:normal;padding-left:30px">Дата составления:&nbsp; <?=$date; ?> г.</span></td>
<td align=right>
<span style="font-size:12.0pt;color:#161616;letter-spacing:
0pt;font-weight:normal;float:right;padding-right:30px">Организация: &laquo;<b><?=$vuz_name; ?></b>&raquo;</span>
</td></tr></table>
</div>-->
...
<table width="100%" cellspacing="0" cellpadding="0" border="1" style="border-collapse:collapse;border:none;" id="main_table">
    <tbody>
        <tr style="height:63.45pt">
            ...
            none;
            padding:0cm 5.4pt 0cm 5.4pt;height:63.45pt">
            <div align="center" style="text-align:center"><span style="font-size:10.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">Серия, номер паспорта (документа, удостоверяющего   личность)</span></div>
            </td>
            ...
            none;
            padding:0cm 5.4pt 0cm 5.4pt;height:63.45pt">
            <div align="center" style="text-align:center"><span style="font-size:10.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">Номер сертификата</span></div>
            ...
            none;
            padding:0cm 5.4pt 0cm 5.4pt;height:63.45pt">
            <div align="center" style="text-align:center"><span style="font-size:10.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">Номер бланка</span></div>
            <!--<div align="center" style="text-align:center"><span style="font-size:10.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">серия,</span></div>
            <div align="center" style="text-align:center"><span style="font-size:10.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">уровень сертификата</span></div>-->
            </td>
           ...
           <!-- <td width="68" style="width:50.8pt;border:solid windowtext 1.0pt;border-left:
            ...
            none;
            padding:0cm 5.4pt 0cm 5.4pt;height:63.45pt">
            <div align="center" style="text-align:center"><span style="font-size:10.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">Подпись лица, прошедшего тестирование (получившего   справку)</span></div>
            </td>-->
        </tr>
...
<div>&nbsp;</div>
<!--
<div align="center" style="text-align:center"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">По настоящей ведомости выдано справок_______________________(количество прописью)<!--<u><?php echo num2str($i);?></u> сколько выдано сертификатов - прописью-->
<!--</span></div>-->
