...
<div align="center" style="text-align:center"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt"><b>выдачи сертификатов&nbsp;прохождения&nbsp;государственного&nbsp;тестирования</b></span></div>
...
<table width="100%" cellspacing="0" cellpadding="0" border="1" style="border-collapse:collapse;border:none;" id="main_table">
    <tbody>
        <tr style="height:63.45pt">
            ...
            none;
            padding:0cm 5.4pt 0cm 5.4pt;height:63.45pt">
            <div align="center" style="text-align:center"><span style="font-size:10.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">Номер бланка сертификата</span></div>
...
<div>&nbsp;</div>
	...
	<? if ($old_view==0) :?>
<div align="center" style="text-align:left;padding-left:30px;"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">По настоящей ведомости выдано сертификатов_______________________(количество прописью)<!--<u><?php echo num2str($i);?></u> сколько выдано сертификатов - прописью--></span></div>
...
12.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;"><nobr><?=$Act->responsible; ?></nobr>
	...
	<div align="center" style="text-align:center"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">По настоящей ведомости выдано сертификатов_______________________(количество прописью)<!--<u><?php echo num2str($i);?></u> сколько выдано сертификатов - прописью--></span></div>
