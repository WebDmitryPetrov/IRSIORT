...
<table class="table table-bordered  table-striped" table-condensed>
	...
	">
            ...
            <td>
                <?= $dogovor->getType(); ?>
                <?if ($dogovor->type_id==2 && $dogovor->print_protocol):?>
                    <br><strong>только для Сводного протокола</strong>
                <?endif?>

                <?if ($dogovor->type_id==2 && $dogovor->print_act):?>
            ...
            <td><a class="btn btn-warning btn-small btn-block"
                ...
                <?php if ($dogovor->scan_id): ?>
                    <a class="btn btn-success btn-smal  btn-block" href="<?= $dogovor->getScan()->getDownloadUrl() ?>">Скачать
                        скан</a>
                <?php endif; ?>
