...
<tr style="height:26.05pt">
    ...
    <td colspan="3" style="border-top:solid windowtext 1.0pt;border-left:none;border-bottom:
...
<tr style="height:25.5pt">
    ...
    <td  colspan="3" style="border-top:solid windowtext 1.0pt;
...
<tr style="height:12.75pt">
    <td  style="border:solid windowtext 1.0pt;border-top:
            none;padding:0cm 5.4pt 0cm 5.4pt;
            height:12.75pt">
        <div align="center" style="text-align:center;"><b><span style="font-size:14.0pt">Договоры</span></b></div>
    </td>
    <td width="120" style="width:90.0pt;border-top:none;border-left:none;
            border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
            padding:0cm 5.4pt 0cm 5.4pt;height:12.75pt">
        <div align="center" style="text-align:center;"><b>Номер</b></div>
    </td>
    <td width="108" style="width:81.0pt;border-top:none;border-left:none;
            border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
            padding:0cm 5.4pt 0cm 5.4pt;height:12.75pt">
        <div align="center" style="text-align:center;"><b>Дата</b></div>
    </td>
    <td width="191" style="width:143.4pt;border-top:none;border-left:none;
            border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
            padding:0cm 5.4pt 0cm 5.4pt;height:12.75pt">
        <div align="center" style="text-align:center;"><b>Название</b></div>
    </td>
</tr>
<?php
    $i=0;
    foreach($university->getDogovors() as $dogovor):

    ?>
<tr style="height:104.1pt">
    <td  nowrap="" style="border:solid windowtext 1.0pt;
            border-top:none;padding:
            0cm 5.4pt 0cm 5.4pt;height:104.1pt">
        <div align="center" style="text-align:center;"><span style="font-size:14.0pt"><?=++$i;?>.</span></div>
    </td>
    <td width="120" nowrap="" style="width:90.0pt;border-top:none;border-left:none;
            border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
            padding:0cm 5.4pt 0cm 5.4pt;height:104.1pt">
        <div align="center" style="text-align:center;">&nbsp;</div>
        <div align="center" style="text-align:center;"><span style="color:black;"><?=$dogovor->number;?></span></div>
    </td>
    <td width="108" nowrap="" style="width:81.0pt;border-top:none;border-left:none;
            border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
            padding:0cm 5.4pt 0cm 5.4pt;height:104.1pt">
        <div align="center" style="text-align:center;">&nbsp;</div>
        <div align="center" style="text-align:center;"><span style="color:black"><?=$C->date($dogovor->date);?></span></div>
    </td>
    <td width="191" nowrap="" style="width:143.4pt;border-top:none;border-left:none;
            border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
            padding:0cm 5.4pt 0cm 5.4pt;height:104.1pt">
        <div align="center" style="text-align:center;"><?=$dogovor->caption;?></div>
    </td>
</tr>
    <?php endforeach; ?>
</tbody>
