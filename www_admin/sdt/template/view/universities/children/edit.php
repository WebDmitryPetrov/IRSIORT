...
<? if ($u->id): ?>
    <a class=""
       href="index.php?action=university_child_view&id=<?php echo $u->id ?>">Вернуться к просмотру</a>
<? else: ?>
    <a class=""
       href="index.php?action=university_children&id=<?php echo $u->parent_id ?>">Вернуться к списку</a>
<? endif ?>
<br><br>
<h1><?= $caption ?></h1>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-xxlarge" name="short_name"
                   ...
                   value="<?= htmlspecialchars($u->getParentedFieldValue('short_name')) ?>" type="text"></div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-xxlarge" name="rector"
                   ...
                   value="<?= htmlspecialchars($u->getParentedFieldValue('rector')) ?>" type="text"></div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-xxlarge" name="contact_phone"
                   ...
                   value="<?= htmlspecialchars($u->getParentedFieldValue('contact_phone')) ?>" type="text"></div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-xxlarge" name="contact_fax"
                   ...
                   value="<?= htmlspecialchars($u->getParentedFieldValue('contact_fax')) ?>" type="text"></div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-xxlarge" name="bank"
                   ...
                   value="<?= htmlspecialchars($u->getParentedFieldValue('bank')) ?>" type="text"></div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-xxlarge" name="city"
                   ...
                   value="<?= htmlspecialchars($u->getParentedFieldValue('city')) ?>" type="text"></div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-xxlarge" name="rc" id="rc" <?= $u->isParentedField('rc') ? 'disabled=disabled' : '' ?>
                   value="<?= htmlspecialchars($u->getParentedFieldValue('rc')) ?>" type="text"></div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-xxlarge" name="lc" id="lc" <?= $u->isParentedField('lc') ? 'disabled=disabled' : '' ?>
                   value="<?= htmlspecialchars($u->getParentedFieldValue('lc')) ?>" type="text"></div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-xxlarge" name="kc" id="kc" <?= $u->isParentedField('kc') ? 'disabled=disabled' : '' ?>
                   value="<?= htmlspecialchars($u->getParentedFieldValue('kc')) ?>" type="text"></div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-xxlarge" name="bik"
                   ...
                   value="<?= htmlspecialchars($u->getParentedFieldValue('bik')) ?>" type="text"></div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-xxlarge" name="inn"
                   ...
                   value="<?= htmlspecialchars($u->getParentedFieldValue('inn')) ?>" type="text"></div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-xxlarge" name="kpp"
                   ...
                   value="<?= htmlspecialchars($u->getParentedFieldValue('kpp')) ?>" type="text"></div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-xxlarge" name="okato"
                   ...
                   value="<?= htmlspecialchars($u->getParentedFieldValue('okato')) ?>" type="text"></div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-xxlarge" name="okpo"
                   ...
                   value="<?= htmlspecialchars($u->getParentedFieldValue('okpo')) ?>" type="text"></div>
    </div>
        ...
        <div class="controls">
            <select name="country_id" id="country_id"
                ...
                <? foreach ($countries as $key => $c): ?>
                    <option value="<?= $key ?>" <?= $key == $u->getParentedFieldValue('country_id') ? 'selected=selected' : '' ?>><?= $c ?></option>
        ...
        <div class="controls">
            <select name="region_id" id="region_id"
                ...
                <? foreach ($regions as $key => $c): ?>
                    <option value="<?= $key ?>" <?= $key == $u->getParentedFieldValue('region_id') ? 'selected=selected' : '' ?>><?= $c ?></option>
