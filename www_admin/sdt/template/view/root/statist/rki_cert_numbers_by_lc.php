...
<h1>Список сертификатов по РКИ по уровням</h1>
...
<? if ($fired): ?>
    <h1>с <?= $from ?> по  <?= $to ?> </h1>
        ...
        <tr>
            <th class="center"><p>Базовый для иностранных работников (<?=count($arrays[0]) ?>)</p></th>
            <th class="center"><p>ТРКИ "Элементарный" А1 (<?=count($arrays[1]) ?>)</p></th>
            <th class="center"><p>ТРКИ "Базовый" А2 (<?=count($arrays[2]) ?>)</p></th>
            <th class="center"><p>ТРКИ "Первый" В1 (<?=count($arrays[3]) ?>)</p></th>
            <th class="center"><p>ТРКИ "Второй" В2 (<?=count($arrays[4]) ?>)</p></th>
            <th class="center"><p>ТРКИ "Третий" С1 (<?=count($arrays[5]) ?>)</p></th>
            <th class="center"><p>ТРКИ "Четвертый" С2 (<?=count($arrays[6]) ?>)</p></th>
            <th class="center"><p>Базовый Гражданство (485)  (<?=count($arrays[7]) ?>)</p></th>
            <th class="center"><p>Базовый Гражданство (730) (<?=count($arrays[8]) ?>)</p></th>
