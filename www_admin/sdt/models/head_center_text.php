...
//        die($sql);
    ...
    public function setTranslate()
    {
        $this->translate = array(
            ...
            'note_prefix' => 'Префикс номера справки',
            'cert_reg_num_prefix' => 'Префикс регистрационного номера сертификата',
            'hc_prefix' => 'Префикс ID тестовой сессии (Юридические лица)',
            'hc_prefix_gc' => 'Префикс ID тестовой сессии (Физические лица)',
            'login_page_title' => 'Название ГЦ в окне авторизации пользователей',
        );
    }
