...
//        die(var_dump($result));
    ...
    public function setTranslate()
    {
        $this->translate = array(
            'id' => 'Èäåíòèôèêàòîğ',
            'name' => 'Íàçâàíèå',
            'short_name' => 'Ñîêğàùåííîå  íàçâàíèå',
            'rector' => 'Ğåêòîğ',
            'form' => 'Ïğàâîâàÿ ôîğìà',
            'legal_address' => 'Şğèäè÷åñêèé àäğåñ',
            'contact_phone' => 'Òåëåôîí',
            'contact_fax' => 'Ôàêñ',
            'contact_email' => 'Email',
            'contact_other' => 'Äîïîëíèòåëüíûå êîíòàêòû',
            'responsible_person' => 'Îòâåòñòâåííûé çà ïğîâåäåíèå òåñòèğîâàíèÿ',
            'comments' => 'Êîììåíòàğèè',
            'bank' => 'Áàíê',
            'city' => 'Ãîğîä',
            'rc' => 'Ğàñ÷åòíûé ñ÷åò',
            'lc' => 'Ëèöåâîé ñ÷åò',
            'kc' => 'Êîğğåñïîíäåíòñêèé ñ÷åò',
            'bik' => 'ÁÈÊ',
            'inn' => 'ÈÍÍ',
            'kpp' => 'ÊÏÏ',
            'okato' => 'Êîä ïî ÎÊÀÒÎ',
            ...
            'country_id' => 'Ñòğàíà',
            'region_id' => 'Ğåãèîí',
            'is_price_change' => 'Ìîæåò ëè èçìåíÿòü öåíû óğîâíåé òåñòèğîâàíèé',
            'is_head' => 'ßâëÿåòñÿ ëè ãîëîâíûì',
            'print_invoice_quoute' => 'Íàëè÷èå êàâû÷åê ó íàçâàíèÿ îğãàíèçàöèè â ñ÷åòå',
            'is_old_act' => 'Ğàçğåøèòü ñîçäàâàòü àêòû ñ äàòîé òåñòèğîâàíèÿ áîëåå 15 äíåé'
    ...
    public function create_user($h_id=0)
    {
...
//die($sql);
    ...
    public function getAvailableUsers($head_id = 0)
    {
...
WHERE tu.head_id =  ' . $head_id . '  AND (tu.univer_id = 0 OR tu.univer_id IS NULL) AND user_type_group_relations.group_id IS NULL
...
//                'short_name',
    ...
    public function getLegalInfo()
    {
        ...
        $university = array(
            'name' => $this->getFieldValue('name'), //'Íàçâàíèå',
            'short_name' => $this->getFieldValue('short_name'), //'Ñîêğàùåííîå  íàçâàíèå',
            'legal_address' => $this->getFieldValue('legal_address'),   //'Şğèäè÷åñêèé àäğåñ',


            'name_parent' => $parent->getFieldValue('name'), //'Íàçâàíèå',
            'short_name_parent' => $parent->getFieldValue('short_name'), //'Ñîêğàùåííîå  íàçâàíèå',
            'legal_address_parent' => $parent->getFieldValue('legal_address'), //'Şğèäè÷åñêèé àäğåñ',

            //'contact_phone' =>  $this->getParentedFieldValue('contact_phone'), //'Òåëåôîí',
            //'contact_fax' =>  $this->getParentedFieldValue('contact_fax'), //'Ôàêñ',
            //'contact_email' =>  $this->getParentedFieldValue('contact_email'), //'Email',
            //'contact_other' =>  $this->getParentedFieldValue('contact_other'), //'Äîïîëíèòåëüíûå êîíòàêòû',
            //'responsible_person' =>  $this->getParentedFieldValue('responsible_person'), //'Îòâåòñòâåííûé çà ïğîâåäåíèå òåñòèğîâàíèÿ',
            //'comments' =>  $this->getParentedFieldValue('comments'), //'Êîììåíòàğèè',

            'rector' => $this->getParentedFieldValue('rector'), //'Ğåêòîğ',
            'form' => $this->getParentedFieldValue('form'), //'Ïğàâîâàÿ ôîğìà',

            'bank' => $this->getParentedFieldValue('bank'), //'Áàíê',
            'city' => $this->getParentedFieldValue('city'), //'Ãîğîä',
            'rc' => $this->getParentedFieldValue('rc'), //'Ğàñ÷åòíûé ñ÷åò',
            'lc' => $this->getParentedFieldValue('lc'), //'Ëèöåâîé ñ÷åò',
            'kc' => $this->getParentedFieldValue('kc'), //'Êîğğåñïîíäåíòñêèé ñ÷åò',
            'bik' => $this->getParentedFieldValue('bik'), //'ÁÈÊ',
            'inn' => $this->getParentedFieldValue('inn'), //'ÈÍÍ',
            'kpp' => $this->getParentedFieldValue('kpp'), //'ÊÏÏ',
            'okato' => $this->getParentedFieldValue('okato'), //'Êîä ïî ÎÊÀÒÎ',
            'okpo' => $this->getParentedFieldValue('okpo'), //'Êîä ïî ÎÊÏÎ',
            //'country_id' =>  $this->getParentedFieldValue('country_id'), //'Ñòğàíà',
            //'region_id' =>  $this->getParentedFieldValue('region_id'), //'Ğåãèîí',
            //'is_price_change' =>  $this->getParentedFieldValue('is_price_change'), //'Ìîæåò ëè èçìåíÿòü öåíû óğîâíåé òåñòèğîâàíèé',
            //'is_head' =>  $this->getParentedFieldValue('is_head'), //'ßâëÿåòñÿ ëè ãîëîâíûì',
            //'print_invoice_quoute' =>  $this->getParentedFieldValue('print_invoice_quoute'), //'Íàëè÷èå êàâû÷åê ó íàçâàíèÿ îğãàíèçàöèè â ñ÷åòå',
            //'is_old_act' =>  $this->getParentedFieldValue('is_old_act'), //'Ğàçğåøèòü ñîçäàâàòü àêòû ñ äàòîé òåñòèğîâàíèÿ áîëåå 15 äíåé'
        );
        return $university;
