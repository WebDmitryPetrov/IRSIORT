...
class CertificateDuplicates extends ArrayObject
{
    ...
    static public function getAllByUserID($id)
    {
        ...
        $sql = 'select * from certificate_duplicate where user_id=\'' . mysql_real_escape_string($id) . '\' AND certificate_duplicate.deleted = 0 order by certificate_issue_date asc';
...
//            $sql = 'select * from country where id=\'' . mysql_real_escape_string($id) . '\'';
            $sql = 'select * from certificate_duplicate
                where user_id=\'' . Connection::getInstance()->escape($id) . '\' AND certificate_duplicate.deleted = 0 order by id desc limit 1';
...
//            (var_dump($result));
    ...
    static function getByBlandkID($id)
    {
...
//            $sql = 'select * from country where id=\'' . mysql_real_escape_string($id) . '\'';
            $sql = 'select * from certificate_duplicate
                where certificate_id=\'' . Connection::getInstance()->escape($id) . '\' AND certificate_duplicate.deleted = 0 order by id desc limit 1';
