...
{
    const TABLE = 'migrant_archive.passport_files';

//    const TYPE_AUDITION = 'audition';

    protected $prefix = '';
    protected $_table = self::TABLE;
    protected $upload_dir = ARCHIVE_UPLOAD_DIR;
    public $man_id;
    public $type;
...
//        die($sql);
    ...
    {
        return '/sdt/?action=archive_man_passport_download&hash=' . $this->download_id;
    }
