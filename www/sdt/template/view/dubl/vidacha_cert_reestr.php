...
// $uroven= $People[0]->getTest()->getLevel()->print; // как в сертификате - было так
...
<? /*<div align="left" style="text-align:left"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt"><b>на уровне: </b><i><?=$uroven?></i></span></div>*/?><br>
