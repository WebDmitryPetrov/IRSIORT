...
if ($balli1<66){$balli1_ocenka='неудовлетворительно'; $razdeli_peresdacha='&laquo;'.$razd1.'&raquo;, ';} else {$balli1_ocenka='удовлетворительно';}
if ($balli2<66){$balli2_ocenka='неудовлетворительно'; $razdeli_peresdacha.='&laquo;'.$razd2.'&raquo;, ';} else {$balli2_ocenka='удовлетворительно';}
if ($balli3<66){$balli3_ocenka='неудовлетворительно'; $razdeli_peresdacha.='&laquo;'.$razd3.'&raquo;, ';} else {$balli3_ocenka='удовлетворительно';}
if ($balli4<66){$balli4_ocenka='неудовлетворительно'; $razdeli_peresdacha.='&laquo;'.$razd4.'&raquo;, ';} else {$balli4_ocenka='удовлетворительно';}
if ($balli5<66){$balli5_ocenka='неудовлетворительно'; $razdeli_peresdacha.='&laquo;'.$razd5.'&raquo;, ';} else {$balli5_ocenka='удовлетворительно';}
...
text-indent:0cm;line-height:150%">проходил тестирование по русскому языку в объёме <b><u><?=$uroven; ?></u></b> уровня и показал следующие результаты по разделам теста:</div>
...
<table border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse;border:none;">
    <tbody>
        <tr>
            ...
            <div align="center" style="margin-right:-1.05pt;text-align:center"><span style="color:#080808">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; М.П.</span></div>
            </td>
            <td width="92" valign="top" style="width:68.65pt;padding:0cm 5.4pt 0cm 5.4pt">
            <div align="center" style="margin-right:1.0cm;text-align:center">&nbsp;</div>
            </td>
