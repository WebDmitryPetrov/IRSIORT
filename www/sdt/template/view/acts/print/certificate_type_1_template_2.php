...
$pdf->SetX($x);
/*!!*/    $pdf->Cell(0, 19.5 + 17.5, '', $borders, 2, 'R'); //отступ
$pdf->Cell($wide_cell+$wide_cell_enhancer, 3, '', $borders, 0, 'C'); //отступ слева
...
$pdf->SetX($x);
/*!!*/   $pdf->Cell(0, 23 - 17.5 + 6+1, '', $borders, 2, 'R'); //отступ
$pdf->Cell($wide_cell-4, 3, $person['city'], $borders, 0, 'C'); //Город
$pdf->Cell($wide_cell+4, 3, '', $borders, 2, 'C'); //отступ справа
...
/*!!!!!!!*/
$pdf->SetX($x);
$pdf->Cell(0, 13-3-1, '', $borders, 2, 'R'); //отступ
$pdf->Cell($wide_cell+8, 3, '', $borders, 0, 'C'); //отступ
$pdf->Cell(46, 3, $person['rukovod_dolzhn_1'].' '.$person['rukovod_dolzhn_2'], $borders, 0, 'C'); //должность
$pdf->Cell(46, 3, $person['rukovod_fio'], $borders, 2, 'R'); //руководитель
//$pdf->Cell(5, 3, '', $borders, 2, 'R'); //отступ

$pdf->SetX($x);
$pdf->Cell(0, 3, '', $borders, 2, 'R'); //отступ
$pdf->Cell(35, 3, $person['print_date'], $borders, 0, 'C'); //Дата печати
$pdf->Cell(36-3, 3, '', $borders, 0, 'C'); //отступ
...
$pdf->Cell(35, 3, $person['print_date'], $borders, 0, 'C'); //Дата печати
$pdf->Cell(36, 3, 'НОВЫЙ', $borders, 0, 'C'); //отступ
$pdf->Cell(23, 3, $person['cert_date'], $borders, 0, 'R'); //срок сертификата
