...
$uroven = $People[0]->getTest()->getLevel()->print; // как в сертификате
...
<div style="width:180mm;">
    ...
    <div align="center" style="text-align:center;pad ding-right: 170px;"><span
                style="font-size:14.0pt;color:#161616;letter-spacing:0pt"><b>Реестр выдачи сертификатов прохождения государственного тестирования <?= $rukovod_center_name ?></b></span>
    </div>
...
font-weight:normal;">М.П</span></div>-->
    ...
    <div align="left" style="text-align:left"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt"><b>на уровне: </b><i><?= $uroven ?></i></span>
    </div>
    <div align="left" style="text-align:left"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt"><b>Организация, проводившая тестирование: </b><i><?= $org_name ?></i></span>
    </div>
    <div align="left" style="text-align:left"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt"><b>Кол-во сертификатов: </b><i><?= $cert_counter ?></i></span>
    </div>
    <div align="left" style="text-align:left"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt"><b>Кол-во справок: </b><i><?= $sprav_counter ?></i></span>
    </div>
    ...
    <div>&nbsp;</div>-->
    <div>&nbsp;</div>
    <div align="left" style="text-align:left"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt"><b>Дата составления: <?= $date; ?>
                г.</b></span></div>
    <!--<div>
        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="1" style="border-collapse:collapse;border:none;"
            ...
            <tr style="height:63.45pt">
                <td width="34"
                    ...
                    <div align="center" style="text-align:center"><span
                                style="font-size:10.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">п/п</span>
                    </div>
                </td>
            ...
            padding:0cm 5.4pt 0cm 5.4pt;height:63.45pt">
                    <div align="center" style="text-align:center"><span
                                style="font-size:10.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">Ф.И.О.</span>
                    </div>
                </td>
            ...
            padding:0cm 5.4pt 0cm 5.4pt;height:63.45pt">
                    <div align="center" style="text-align:center"><span
                                style="font-size:10.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">Серия, номер паспорта (документа, удостоверяющего   личность)</span>
                    </div>
                </td>
            ...
            padding:0cm 5.4pt 0cm 5.4pt;height:63.45pt">
                    <div align="center" style="text-align:center"><span
                                style="font-size:10.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">Номер бланка</span>
                    </div>
                    <!--<div align="center" style="text-align:center"><span style="font-size:10.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">серия,</span></div>
                    <div align="center" style="text-align:center"><span style="font-size:10.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">уровень сертификата</span></div>-->
                </td>
            ...
            padding:0cm 5.4pt 0cm 5.4pt;height:63.45pt">
                    <div align="center" style="text-align:center"><span
                                style="font-size:10.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">Дата тестирования</span>
                    </div>
                </td>
