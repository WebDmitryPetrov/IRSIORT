...
<div align="center" style="text-align:center">&nbsp;</div>
<div align="right" style="text-align:right"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;padding-right: 60px;"><?=$sign->position?> <?=TEXT_HEADCENTER_SHORT_IP?></span></div>
...
<table width="100%" cellspacing="0" cellpadding="0" border="1" style="border-collapse:collapse;border:none;" id="main_table">
    <tbody>
        <tr style="height:63.45pt">
            ...
            <td width="94" valign="top" style="width:70.85pt;border-top:none;border-left:
            none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;padding:0cm 5.4pt 0cm 5.4pt;height:17.0pt">
            <div align="center" style="text-align:center"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">'./*TestLevel::getByID(ActTest::getByID($Man->test_id)->level_id)*/TestLevel::getByID(ActTest::getByID($Man->test_id)->level_id)->getPrintSummaryTable().'</span></div>
            </td>
...
<? if ($old_view==0) :?>
<div align="center" style="text-align:center;padding-left:30px;"><span style="font-size:12.0pt;color:#161616;letter-spacing:0pt;font-weight:normal;">По настоящей ведомости выдано справок_______________________(количество прописью)<!--<u><?php echo num2str($i);?></u> сколько выдано сертификатов - прописью--></span></div>
