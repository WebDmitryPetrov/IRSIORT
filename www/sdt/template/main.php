...
<head>
    ...
    <script src="content/js/underscore.string.js"></script>
    <script src="content/js/js.js"></script>
    <script src="content/js/jquery.autocolumnlist.js"></script>
...
<div class="navbar  navbar-static-top">
    ...
    <p class="navbar-text pull-right" style="padding-right:5px">
						<span class="logged_as">Вошли как <strong><?php
